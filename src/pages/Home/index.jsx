            ...
            <section className="about">
                ...
                <div className="about__article">
                    <p>Let’s start with the words you use to describe yourself.
                        ...
                        but our singles consistently tell us that a profile description matters more to them than a
                        photo.
                    </p>
                    <p>
                    ...
                    <p>
                        And words can break the ice! It can be hard to introduce yourself to a single you find
                        interesting;
                        it is always difficult to find the right way to approach them and find THE message that will
